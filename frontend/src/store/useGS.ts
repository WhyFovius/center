...
export const useGS = create<GS>((set, get) => ({
  ...
  osTasks: {
    ...
    // Attack Scenarios
    scenario_mail_phishing_payroll: false,
    scenario_mail_ceo_fraud: false,
    scenario_browser_fake_bank: false,
    scenario_browser_drive_by: false,
    scenario_messenger_colleague_password: false,
    scenario_messenger_deepfake_call: false,
    scenario_terminal_backdoor: false,
    scenario_security_mass_attack: false,
    scenario_wifi_evil_twin: false,
    scenario_deepfake_it_support: false,
    scenario_settings_security_checklist: false,
    scenario_attack_full_apt: false,
  },
